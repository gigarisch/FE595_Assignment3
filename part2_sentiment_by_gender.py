...
from part3_utils import top_output
import pprint
...
def sentiment_by_gender():
    ...
    # =============================================================================
    n=int(10)
    pprint.pprint("Worst {} Female".format(n))
    pprint.pprint(top_output(shes_dict,n))
    pprint.pprint("Best {} Female".format(n))
    pprint.pprint(top_output(shes_dict, n, True))
    pprint.pprint("Worst {} Male".format(n))
    pprint.pprint(top_output(hes_dict))
    pprint.pprint("Best {} Male".format(n))
    pprint.pprint(top_output(hes_dict, n, True))
...
# 'Best 10 Female'
# ["1. Polarity: 0.9 Sentence: She's a brilliant insomniac Hell's Angel from "
#  'beyond the grave ',
#  "2. Polarity: 0.9 Sentence: She's a manipulative psychic opera singer with an "
#  'incredible destiny ',
#  "3. Polarity: 0.9 Sentence: She's a cold-hearted snooty bodyguard with an "
#  'incredible destiny ',
#  "4. Polarity: 0.9 Sentence: She's a brilliant motormouth bodyguard with an "
#  'incredible destiny ',
#  "5. Polarity: 0.9 Sentence: She's a manipulative belly-dancing museum curator "
#  'with an incredible destiny, ',
#  "6. Polarity: 0.85 Sentence: She's a beautiful bisexual widow with a "
#  'flame-thrower ',
#  "7. Polarity: 0.85 Sentence: She's a beautiful insomniac opera singer with an "
#  'MBA from Harvard ',
#  "8. Polarity: 0.7 Sentence: She's a brilliant bisexual safe cracker with "
#  "someone else's memories ",
#  "9. Polarity: 0.6 Sentence: She's a green-fingered streetsmart lawyer with "
#  'her own daytime radio talk show ',
#  "10. Polarity: 0.6 Sentence: She's a virginal kleptomaniac schoolgirl with "
#  'her own daytime radio talk show ']
# 'Worst 10 Male'
...
#  "3. Polarity: 0.4166666666666667 Sentence: He's a hate-fuelled gay "
#  'photographer from a doomed world ',
#  "4. Polarity: 0.4166666666666667 Sentence: He's a war-weary gay cowboy who "
#  'must take medication to keep him sane ',
#  "5. Polarity: 0.41111111111111115 Sentence: He's a superhumanly strong "
#  'small-town paranormal investigator on the hunt for the last specimen of a '
#  'great and near-mythical creature ',
#  "6. Polarity: 0.41111111111111115 Sentence: He's a superhumanly strong pirate "
...
#  "8. Polarity: 0.4 Sentence: He's an all-American umbrella-wielding dwarf with "
#  'a winning smile and a way with the ladies ',
#  "9. Polarity: 0.4 Sentence: He's a leather-clad guitar-strumming romance "
#  'novelist on the hunt for the last specimen of a great and near-mythical '
#  'creature ',
#  "10. Polarity: 0.4 Sentence: He's a maverick guitar-strumming librarian on "
#  'the hunt for the last specimen of a great and near-mythical creature ']
# 
# =============================================================================
